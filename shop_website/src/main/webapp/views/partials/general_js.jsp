...
<script src='<c:url value="/public/vendors/fontawesome-5.15.1/js/all.min.js"/>'></script>
<script src='<c:url value="/public/vendors/fancybox/dist/jquery.fancybox.min.js"/>'></script>
<script src='<c:url value="/public/vendors/bootstrap-4/js/bootstrap.min.js"/>'></script>
