								...
								<li class="dropdown head-dpdn"><a href="#"
									...
									<ul class="dropdown-menu">
										...
										<li><a href="#">
												<div class="user_img">
													<img
														src="<c:url value="/public/vendors/admin-template/images/in11.jpg"/>"
														alt="">
												</div>
										...
										<li class="odd"><a href="#">
												<div class="user_img">
													<img
														src="<c:url value="/public/vendors/admin-template/images/in10.jpg"/>"
														alt="">
												</div>
												<div class="notification_desc">
													<p>Lorem ipsum dolor</p>
										...
										<li><a href="#">
												<div class="user_img">
													<img
														src="<c:url value="/public/vendors/admin-template/images/in9.jpg"/>"
														alt="">
												</div>
												<div class="notification_desc">
													<p>Lorem ipsum dolor</p>
								...
								<li class="dropdown head-dpdn"><a href="#"
									...
									<ul class="dropdown-menu">
										...
										<li><a href="#">
												<div class="user_img">
													<img
														src="<c:url value="/public/vendors/admin-template/images/in8.jpg"/>"
														alt="">
												</div>
												<div class="notification_desc">
													<p>Lorem ipsum dolor</p>
										...
										<li class="odd"><a href="#">
												<div class="user_img">
													<img
														src="<c:url value="/public/vendors/admin-template/images/in6.jpg"/>"
														alt="">
												</div>
												<div class="notification_desc">
													<p>Lorem ipsum dolor</p>
										...
										<li><a href="#">
												<div class="user_img">
													<img
														src="<c:url value="/public/vendors/admin-template/images/in7.jpg"/>"
														alt="">
												</div>
												<div class="notification_desc">
													<p>Lorem ipsum dolor</p>
								...
								aria-expanded="false">
									<div class="profile_img">
										<span class="prfil-img"> <img
											src="<c:url value="/public/vendors/admin-template/images/in4.jpg"/>"
											alt=""></span>
										<div class="user-name">
											<p>Malorum</p>
							...
							<div class="card-body p-b-20">
								<div class="list-group">
									<a class="list-group-item media" href="">
										<div class="pull-left">
											<img class="lg-item-img"
												src="<c:url value="/public/vendors/admin-template/images/in1.jpg"/>"
												alt="">
										</div>
										...
										<div class="pull-left">
											<img class="lg-item-img"
												src="<c:url value="/public/vendors/admin-template/images/in2.jpg"/>"
												alt="">
										</div>
										<div class="media-body">
											<div class="pull-left">
										...
										<div class="pull-left">
											<img class="lg-item-img"
												src="<c:url value="/public/vendors/admin-template/images/in3.jpg"/>"
												alt="">
										</div>
										<div class="media-body">
											<div class="pull-left">
				...
				<ul id="menu">
					...
					<li id="menu-academico"><a
						href="<c:url value="/dashboard/product"/>"><i
							class="fa fa-cubes nav_icon"></i><span>Add product</span>
							<div class="clearfix"></div></a></li>
				</ul>
			</div>
		</div>
